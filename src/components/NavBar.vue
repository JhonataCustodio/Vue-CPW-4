            ...
            <b-collapse id="nav-collapse" is-nav>
                <b-navbar-nav v-show="showFunctions">
                    ...
                    <b-nav-item-dropdown text="Cadastros">
                        <b-dropdown-item v-on:click="categoria">Categoria</b-dropdown-item>
                        <b-dropdown-item v-on:click="produto">Produtos</b-dropdown-item>
                    </b-nav-item-dropdown>
                </b-navbar-nav>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            categoria: function () {
                this.$store.dispatch('Categoria.vue');
                this.$router.push('/Categoria')
            },
            produto: function(){
                this.$store.dispatch('produto');
